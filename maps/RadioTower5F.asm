...
RadioTower5F_MapEvents:
	...
	object_event  8,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RadioTower5FTMEarthquake, EVENT_RADIO_TOWER_5F_TM_EARTHQUAKE
