...
GoldenrodUndergroundSwitchRoomEntrancesTMPsychic_M:
...
GoldenrodUndergroundSwitchRoomEntrances_MapEvents:
	...
	object_event  1, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, GoldenrodUndergroundSwitchRoomEntrancesTMPsychic_M, EVENT_GOLDENROD_UNDERGROUND_SWITCH_ROOM_ENTRANCES_TM_PSYCHIC_M
