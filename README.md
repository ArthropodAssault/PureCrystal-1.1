...
If playing the PureCrystalPSS ROM the physical-special split is implemented. If playing PureCrystal, it is not. In PureCrystalPSS, all move's physical/special categorization is the same as in the mainline games.
