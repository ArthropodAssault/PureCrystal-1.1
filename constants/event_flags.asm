...
; Johto itemballs
	...
	const EVENT_OLIVINE_LIGHTHOUSE_5F_METAL_COAT
	const EVENT_OLIVINE_LIGHTHOUSE_5F_TM_SWAGGER
	const EVENT_OLIVINE_LIGHTHOUSE_6F_TM_GIGA_DRAIN
	...
	const EVENT_GOLDENROD_UNDERGROUND_SWITCH_ROOM_ENTRANCES_TM_PSYCHIC_M
...
; New to Crystal
	...
	const EVENT_RADIO_TOWER_5F_TM_EARTHQUAKE
